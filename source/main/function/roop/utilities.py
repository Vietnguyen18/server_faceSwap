...
def extract_frames(target_path: str, fps: float = 30) -> bool:
    ...
    return temp_directory_path, run_ffmpeg(
        [
            "-hwaccel",
            "auto",
            "-i",
...
def create_video(target_path: str, fps: float = 30) -> bool:
    ...
    # temp_output_path = target_path
    # temp_directory_path = get_temp_directory_path(target_path)
    temp_directory_path = target_path
    ...
    print("_______________________" + str(target_path))
    return run_ffmpeg(commands)


def restore_audio(vid_path: str, target_path: str, output_path: str) -> None:
    temp_output_path = get_temp_output_path(target_path)
    print("temp-out", temp_output_path)
    # temp_output_path = target_path
    done = run_ffmpeg(
        [
            "-i",
...
def get_temp_directory_path(target_path: str) -> str:
    ...
    target_directory_path = "/home/thinkdiff/Documents/wedding/damcuoi"
    print("_____target_directory_path_____" + target_directory_path)
    return os.path.join(
        target_directory_path,
        TEMP_DIRECTORY,
        f"{target_name}_{random.randint(10000, 99999)}",
    )
