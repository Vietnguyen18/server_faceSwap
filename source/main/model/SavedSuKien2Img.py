...
class SavedSuKien2Img(db.Model):
    __tablename__ = 'saved_sukien_2_image'
    ...
    link_tar_goc = db.Column(db.Text(collation='utf8mb4_general_ci'), nullable=True, default=None)
